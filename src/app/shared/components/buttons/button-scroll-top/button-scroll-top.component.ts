...
@Component({
  ...
  template: `
    <div class="position-fixed bottom-0 end-0 me-3 mb-3 rounded bg-theme-dark text-theme-light z-1 font-size-125 p-3 cursor-pointer"
      *ngIf="scrollY > 250" (click)="scrollTop()" @fadeInOutAnimation>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="svg-path-light" width="30px" height="30px">
          <path
